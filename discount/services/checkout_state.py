    ...
    *,
    ...
    if not pid:
        return (
            ...
            "3. REQUIRED: call search_products with the customer's product keyword "
            "(empty query ONLY if they asked what you sell in general, with no item name). "
            "When a match is found the backend locks "
